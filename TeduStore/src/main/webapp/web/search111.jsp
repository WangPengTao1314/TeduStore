...
<body>
	<div class="big" style="height:750px;">
        ...
        <c:forEach items="${goodsList}" var="goods">
					<div class="lf box" id="d1">
						...
						<div class="describe">
							<p onclick="toItemInfo(${item.id})" style="width:230px;overflow:hidden;">${goods.title}</p>
	...
	<!-- 尾部-->
  <div style="height:20px" align="right" style="margin-rigth:80px">共${count }种商品，共${pages}页|
  <c:forEach var="i" begin="1" end="${pages}">
  <a href="../goods/showSearch.do?categoryId=#{categoryId }&&pages=${i}">${i}</a>
